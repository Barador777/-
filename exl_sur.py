...
async def handle_inline_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "level_easy":
        ...
        await query.edit_message_text(
            "Режим работы Ижевского техникума экономики, управления и права Удмуртпотребсоюза (ИТЭУП) в 2025 году: ПН–ПТ — с 8:00 до 17:00, воскресенье и суббота — выходные.")
